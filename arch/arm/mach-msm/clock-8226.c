...
static struct clk_lookup msm_clocks_8226[] = {
	...
	CLK_LOOKUP("cam_src_clk", mclk1_clk_src.c, "7a.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", mclk1_clk_src.c, "6a.qcom,camera"),
	...
	CLK_LOOKUP("cam_clk", camss_mclk1_clk.c, "7a.qcom,camera"),
	CLK_LOOKUP("cam_clk", camss_mclk1_clk.c, "6a.qcom,camera"),
